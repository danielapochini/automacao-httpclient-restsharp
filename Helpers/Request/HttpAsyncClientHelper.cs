...
namespace WebServiceAutomation.Helpers.Request
{
    public class HttpAsyncClientHelper
    {
        ...
        public async Task<RestResponse> PerformGetRequest(string requestUrl, Dictionary<string, string> httpHeaders)
        {
        ...
        public async Task<RestResponse> PerformPostRequest(string requestUrl, HttpContent httpContent, Dictionary<string, string> httpHeaders)
        {
            httpClient = AddHeadersAndCreateHttpClient(httpHeaders);
